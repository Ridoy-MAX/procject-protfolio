      ...
      <div class="col-md-3">
         ...
         <div class="card">
           <div class="card-header">
             ...
             <h5>Social media add from</h5>
           </div>
           <div class="card-body">
                          <form action="social_media_post.php" method="post" class="card " >
                                       ...
                                       <div class="mb-3 overflow-scroll" style="height:300px">
                                        ...
                                        <?php foreach ($icons as $icon): ?>
                                              <span class="btn btn-sm btn-dark p-2 m-1">
                                                <i class="fa <?= $icon?>"></i>
                                              </span>
                                         <?php endforeach ?>
          ...
          <div class="row ">
            ...
            <table class="table  table-hover  p-2">
                ...
                <tbody>
                    ...
                    <?php
                       foreach ($from_db as $key => $social_media):
                     ?>
                     ...
                     <tr >
                      <!-- <th scope="row">1</th> -->
                          ...
                          <td> <a href="#"> <?=$social_media['social_link']?></a>  </td>

                          <td class="bg-black">  <?=$social_media['social_icon']?>  </td>
